...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    //             LT(_FN0, KC_LGUI),  KC_SPACE,    KC_LEFT,    KC_DOWN,    KC_RIGHT
    ...
    //             KC_NO,  KC_ESC,     KC_NO,      KC_NO,       KC_NO,     KC_NO,      KC_NO,                           KC_NUM, KC_PSLS, KC_PAST,   KC_PMNS,
    //             KC_NO,  KC_GRV,     KC_1,       KC_2,        KC_3,      KC_4,       KC_5,                            KC_P7,  KC_P8,   KC_P9,     KC_PPLS,
    //             KC_NO,  G(KC_TAB),  G(KC_Q),    G(KC_W),     G(KC_E),   G(KC_R),    G(KC_T),                         KC_P4,  KC_P5,   KC_P6,     KC_PEQL,
    //             KC_NO,  KC_LSFT,    G(KC_A),    G(KC_S),     KC_D,      KC_F,       KC_G,                            KC_P1,  KC_P2,   KC_P3,     KC_NO,
    //             KC_NO,  KC_CAPS,    G(KC_Z),    G(KC_X),     G(KC_C),   G(KC_C),    G(KC_B),                         KC_NO,  KC_P0,   KC_PDOT,   KC_PENT,
    //                                                                     KC_LALT,    KC_LCTL,
    //                                                                     KC_LGUI,    G(KC_SPACE),
    ...
    //             KC_N,       KC_M,       KC_COMM,    KC_DOT,     KC_SLSH,    KC_MINS,    KC_RSFT,                KC_PENT,  KC_P0,   KC_PDOT,   KC_PENT,
    //             KC_LALT,    KC_LCTL,                KC_UP,
    //             KC_LGUI,    KC_SPACE,    KC_LEFT,    KC_DOWN,    KC_RIGHT
